	...
	<footer class="article-footer text-center">
		<div class="share outlined border-purple br-20">
			<div class="a2a_kit a2a_default_style grid-x align-center">
				...
				<a class="grid-x align-middle align-center circle a2a_button_facebook <?php echo $color_theme;?>-bg" href="#">
				...
				<a class="grid-x align-middle align-center circle a2a_button_twitter <?php echo $color_theme;?>-bg" href="#">
				...
				<a class="grid-x align-middle align-center circle a2a_button_linkedin border-<?php echo $color_theme;?> <?php echo $color_theme;?>-bg" data-url="<?php echo get_permalink();?>" href="#">
