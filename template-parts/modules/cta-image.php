	...
	<div class="inner">
		<div class="grid-container">
			<div class="grid-x grid-padding-x align-middle">
				<div class="left cell small-6 large-5">
					<?php if( !empty($heading)):?>
						<h2 class="text-center h3 color-<?php echo $button_color;?>"><?php echo $heading;?></h2>
					<?php endif;?>
					<?php if($button_link):?>
				...
				<?php 
				if( !empty( $image ) ): ?>
				<div class="right cell small-6 large-6 large-offset-1">
